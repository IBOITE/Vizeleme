...
public class SerbestInfor {
    ...
    public SerbestInfor(int id, int idSignin, String ogAd, String ogSoyad, String ogTC, String ogDogum, String ogScan) {
        this.id = id;
    ...
    public SerbestInfor(int idSignin, String ogAd, String ogSoyad, String ogTC, String ogDogum, String ogScan) {
        this.idSignin = idSignin;
        this.ogAd = ogAd;
        this.ogSoyad = ogSoyad;
        this.ogTC = ogTC;
